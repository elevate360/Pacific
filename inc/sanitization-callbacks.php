 ...
 */
function pacific_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function pacific_sanitize_css( $css ) {
 ...
 */
function pacific_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function pacific_sanitize_email( $email, $setting ) {
 ...
 */
function pacific_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function pacific_sanitize_html( $html ) {
 ...
 */
function pacific_sanitize_image( $image, $setting ) {
 ...
 */
function pacific_sanitize_nohtml( $nohtml ) {
 ...
 */
function pacific_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function pacific_sanitize_number_range( $number, $setting ) {
 ...
 */
function pacific_sanitize_select( $input, $setting ) {
 ...
 */
function pacific_sanitize_url( $url ) {
