 ...
 class el_services extends el_content_type{
	...
	private $meta_field_args = array(
		array(
			'id'			=> 'subtitle',
			'title'			=> 'Subtitle',
			'description'	=> 'Subtitle / tagline to be displayed under the title of the service',
			'type'			=> 'text',
    ...
    public static function get_service_categories_html($terms_array){
		...
		$html .= '<div class="services-categories el-row nested inner small-padding-top-small medium-padding-top-x-large">';
			$counter = 0;
				...
				foreach($terms_array as $term){
					...
					$html .= '<div class="information el-col-small-12 el-col-medium-8 el-col-medium-offset-2" id="information-for-category-' . $term_id  . '">';
						if(!empty($term_description)){
							$html .= '<h3 class="fat small-margin-top-bottom-none">' . $term_name . '</h3>';
	...
	public static function get_single_service_card_html($post_id){
		...
		if($post){
			...
			$html .= '<div class="service-card equal-height-item el-col-small-12 el-col-medium-3 small-margin-bottom-medium">';
					...
					$html .= '<div class="inner">';	
						...
						$html .= '<div class="back">';
							$html .= '<div class="back-inner" style="background-color: ' . $term_color . ';">';
								$html .= '<div class="excerpt">' . $post_excerpt . '</div>';
