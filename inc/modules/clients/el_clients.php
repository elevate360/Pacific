 ...
 */
 ...
 class el_clients extends el_content_type{
	...
	public function __construct(){
		...
		add_action('el_display_client_card_listing', array($this, 'display_client_cards'));
			
		
	}

	//hooked function to display a listing of client cards
	public static function display_client_cards(){
		...
		if($posts){
			$html .= '<article class="client-cards animation-container el-row small-margin-top-bottom-medium">';
				$html .= '<div class="el-col-small-12 el-col-medium-3">';
					$html .= '<hr class="orange fat"/>';
					$html .= '<h1 class="fat">Some of our happy clients</h1>';
				$html .= '</div>';
